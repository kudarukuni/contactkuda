      ...
      <div className="dataContainer">    
        ...
        <div className="bio">
          <font color="white">Hi, 👋 I am Kuda Rukuni and I am a Full Stack IoT, Web3.0 and Software Engineer. 
            ...
            <br/><br/><br>
            For more information and booking please call me on this number <a href="tel:+263782516263" target="_blank"><strong></font><font color="gold">+263 782 51 6263</font><font color="white"></strong></a> and if you 
            prefer to communicate via email, please feel free to send mail to this address <a href="mailto:krukuni@gmail.com" target="_blank"><strong></font><font color="gold">krukuni@gmail.com</font><font color="white">.</strong></a>
            <br/><br/><br>
